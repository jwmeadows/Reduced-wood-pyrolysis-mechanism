...
```
In order to refer to the specific Chemkin file, please cite this website as follows:

```
@misc{wood_pyrolysis_mech,
    title = {Wood_pyrolysis_mech_website},
    url = {https://github.com/jwmeadows/Reduced-wood-pyrolysis-mechanism},
